...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 flex flex-col min-h-screen bg-white transition-transform duration-300 transform md:relative md:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'
          }`}
        style={{
      ...
      >
        ...
        >
          ...
          <p className="text-[10px] mt-0.5" style={{ color: '#9B7E6A' }}>rrvcrackers@gmail.com</p>
        </div>
      </aside>
    </>
  );
