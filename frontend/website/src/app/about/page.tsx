    ...
    <div className="flex-1 w-full" style={{ background: 'var(--bg-page)' }}>
      ...
      >
        ...
        <div
          ...
          style={{ background: 'radial-gradient(ellipse at 50% 0%, rgba(212,175,55,0.2), transparent 70%)' }}
        />
        {[...Array(12)].map((_, i) => (
          <span
            key={i}
            className="absolute text-[#D4AF37] animate-sparkle-float"
            style={{
        ...
        <div className="relative z-10 animate-fade-up">
          <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-bold tracking-widest uppercase mb-6 bg-[#D4AF37]/10 text-[#D4AF37] border border-[#D4AF37]/30 backdrop-blur-sm">
          ...
          >
            About <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D4AF37] to-[#AA8222]">RRV Crackers</span>
          </h1>
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-16 flex flex-col gap-14">
        ...
        <div className="card p-8 md:p-12 flex flex-col md:flex-row gap-10 items-center">
          <div className="flex-shrink-0 text-center">
            <div className="text-8xl" style={{ filter: 'drop-shadow(0 8px 24px rgba(212,175,55,0.3))' }}>🪔</div>
            <div className="mt-3 text-xs font-bold tracking-widest uppercase" style={{ color: '#D4AF37' }}>Est. 2005</div>
          </div>
          <div>
