  ...
  return (
    <div className="w-full flex flex-col min-h-screen">
      ...
      <section className="pt-20 pb-12 px-4 text-center">
        ...
        <p className="text-gray-300 max-w-lg mx-auto">Stay up to date with the latest news, festival tips, and announcements from RRV Crackers.</p>
      </section>
              ...
              {blogs.map((blog) => (
                <article key={blog.id} className="bg-[#1A2859] rounded-3xl overflow-hidden shadow-lg hover:shadow-[0_15px_35px_rgba(212,175,55,0.15)] transition-all duration-500 border border-[#D4AF37]/20 flex flex-col group hover:-translate-y-2 cursor-pointer" onClick={() => setSelectedBlog(blog)}>
                  ...
                  <div className="p-8 flex flex-col flex-1 relative bg-gradient-to-b from-[#1A2859] to-[#0A1128]">
                    <div className="flex items-center gap-2 mb-4 text-xs font-bold tracking-widest uppercase text-gray-400">
                    ...
                    <div className="text-gray-300 mb-8 text-sm leading-relaxed line-clamp-4 prose prose-sm prose-invert max-w-none" dangerouslySetInnerHTML={{ __html: blog.content }} />
